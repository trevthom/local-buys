  ...
  return (
    <Modal onClose={onClose} max="max-w-lg">
      ...
      <div className={"space-y-4 p-5 text-sm leading-relaxed sm:p-6 " + t.text} style={FONT_BODY}>
        <p className="font-bold">Nostr is a decentralized network for social apps, messaging, communities, and more.</p>
        <p className={t.subtle}>Nostr is an open, decentralized social protocol. Unlike traditional platforms, your account isn't tied to a single company. Your identity, followers, and content can be used across many Nostr-compatible applications.</p>
